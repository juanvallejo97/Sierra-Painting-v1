      ...
      child: ListView(
        ...
        children: [
          ...
          SwitchListTile(
            ...
            value: c.darkMode, onChanged: c.setDark),
          SwitchListTile(
            title: const Text('Right‑to‑left (RTL)'),
            value: c.rtl, onChanged: c.setRtl),
          ListTile(
            title: const Text('Text scale'),
            subtitle: Slider(
              min: 0.8, max: 1.6, divisions: 8, value: c.textScale,
              onChanged: c.setScale),
          ),
          const Divider(),
          SwitchListTile(
            title: const Text('Simulate loading'),
            value: c.simulateLoading, onChanged: c.setLoading),
          SwitchListTile(
            title: const Text('Simulate error'),
            value: c.simulateError, onChanged: c.setError),
