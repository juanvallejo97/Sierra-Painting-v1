...
class EstimateEditorDemo extends StatefulWidget {
  ...
  @override
  State<EstimateEditorDemo> createState() => _EstimateEditorDemoState();
}
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            OutlinedButton.icon(
              onPressed: () =>
                  setState(() => _items.add(LineItem('New item', 1, 0))),
          ...
          children: [
            ...
            Expanded(
              child: TextFormField(
                ...
                validator: (v) =>
                    (double.tryParse(v ?? '') == null) ? 'Num' : null,
              ),
            ),
            const SizedBox(width: 8),
